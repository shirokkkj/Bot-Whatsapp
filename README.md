[1] - You need a install Selenium to execute this bot. To open your terminal, press ```CONTROL + ' ``` and write in ```pip install Selenium``` and install webdriver. In terminal, write: ```pip install webdriver-manager```
